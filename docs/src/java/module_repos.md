...
The <img style="vertical-align:middle" src="./images/open_codespc.png" height="25px" >
...
The <img style="vertical-align:middle" src="./images/fork_button.png" height="25px" >
...
The <img style="vertical-align:middle" src="./images/view_button.png" height="25px" >
...
On that page, click on the <img style="vertical-align:middle" src="./images/fork_button.png" height="25px" > button.

Then click on the green "Create a Fork" button. When the page finishes loading, you will get a page that looks like this:

<center><img src="./images/l0-m0_repo.png" width="500px"></center>
...
<center><img src="./images/create_codespace.png" style="width: 500px;"></center>
...
<center><img src="./images/vscode.png" width="600px"></center>

## Fork and Create Codespace in one step

You can fork and create a codespace in one step with the  <img style="vertical-align:middle" src="./images/open_codespc.png" height="25px" > button.
Press that button and you will get this screen to configure a new codespace built from the
repo: 

<center><img style="vertical-align:middle" src="./images//new_codespace_button.png" ></center>
...
<center><img src="./images/ports_pane.png" width="600px"></center>
...
<center><img src="./images/rundebug.png" width="60px"></center>

At the top of the screen you will see the "RUN AND DEBUG" menu.

<center><img src="./images/run_menu_closed.png" width="300px"></center>

Click on the down arrow to open the menu. 

<center><img src="./images/run_menu_open.png" width="300px"></center>
...
<center><img src="./images/active_codespace.png" width="600px"></center>
